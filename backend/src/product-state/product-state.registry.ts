...
export const PRODUCT_FEATURES: ProductFeature[] = [
  ...
  feature({ key: "tools.overview", titleFa: "ابزارهای تشخیصی", titleEn: "Diagnostic tools", route: "/tools", groupKey: "integrations", order: 5, state: "partial", userVisible: true, navigationVisible: false, backendReady: true, apiReady: true, uiReady: true, tested: true, reason: "Stable non-executing landing route only; diagnostic workers are deferred to later Task 19.2 milestones." }),
  feature({ key: "tools.network_check", titleFa: "تست سریع شبکه", titleEn: "Network quick check", route: "/tools/network-check", groupKey: "integrations", order: 6, state: "partial", userVisible: true, navigationVisible: false, backendReady: true, apiReady: true, uiReady: true, tested: true, reason: "Stable non-executing route only; Check-Host and scan execution are deferred to later Task 19.2 milestones." }),
