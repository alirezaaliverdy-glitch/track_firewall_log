...
const ALIAS_MAP: Record<MappableField, string[]> = {
  ...
  srcIp:           ["srcip", "src_ip", "src ip", "source ip", "sourceip", "src-address",
                    "source address", "source", "srcaddr", "src"],
  dstIp:           ["dstip", "dst_ip", "dst ip", "destination ip", "destinationip", "dst-address",
                    "destination address", "destination", "dstaddr", "dst"],
  srcPort:         ["srcport", "src_port", "src port", "source port", "sourceport",
                    "src-port", "sport"],
  dstPort:         ["dstport", "dst_port", "dst port", "destination port", "destinationport",
                    "dst-port", "dport"],
